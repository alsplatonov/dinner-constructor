...
public class DinnerConstructor {
    ...
    public void addNewDish(String dishType, String dishName) {
        ArrayList<String> dishesForType = dinnersByType.get(dishType); //переменая для списка блюд
        if (dishesForType == null) { //здесь мы должны проверить, содержит ли наше хранилище такое блюдо
    ...
    public boolean checkType(String type) {
        return dinnersByType.get(type) != null; //если хранилище уже содержит такое блюдо - вернём true
    }
